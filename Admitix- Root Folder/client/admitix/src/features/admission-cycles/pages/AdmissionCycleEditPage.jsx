...
import { getAdmissionCyclesById, updateAdmissionCycle } from '../services'
import { admissionCyclesFields } from '../constants'

export default function AdmissionCycleEditPage() {
  const { id } = useParams()
  ...
  const handleSubmit = (values) => {
    ...
    setError('')
    updateAdmissionCycle(id, values)
  ...
  return (
    <div>
      <PageHeader title="Edit Admission Cycle" subtitle="Update this admission cycle record." />
