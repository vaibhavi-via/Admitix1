...
import { getDocumentTypesById, updateDocumentType } from '../services'
...
export default function DocumentTypeEditPage() {
  ...
  return (
    <div>
      <PageHeader title="Edit Document Type" subtitle="Update this document type record." />
