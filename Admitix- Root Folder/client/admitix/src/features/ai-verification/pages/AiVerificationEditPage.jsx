...
import { getAiVerificationById, updateAiVerification } from '../services'
import { aiVerificationFields } from '../constants'

export default function AiVerificationEditPage() {
  const { id } = useParams()
  ...
  const handleSubmit = (values) => {
    ...
    setError('')
    updateAiVerification(id, values)
  ...
  return (
    <div>
      <PageHeader title="Edit AI Verification" subtitle="Update this ai verification record." />
