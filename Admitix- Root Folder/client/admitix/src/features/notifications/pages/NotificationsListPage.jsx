...
import { getNotificationsList, deleteNotification } from '../services'
...
export default function NotificationsListPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Notifications"
        subtitle="Manage notifications records."
        actions={
          <>
            <button
              onClick={load}
      ...
      <DataTable
        ...
        onEdit={(row) => navigate(`/notifications/${row.id}/edit`)}
        onDelete={(row) => setPendingDelete(row)}
        emptyMessage="No notifications found yet."
      />
