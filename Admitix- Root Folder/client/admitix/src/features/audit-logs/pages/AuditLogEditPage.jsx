...
import { getAuditLogsById, updateAuditLog } from '../services'
import { auditLogsFields } from '../constants'

export default function AuditLogEditPage() {
  const { id } = useParams()
  ...
  return (
    <div>
      <PageHeader title="Edit Audit Log Entry" subtitle="Update this audit log entry record." />
