...
import { getEducationalDetailsById, updateEducationalDetail } from '../services'
import { educationalDetailsFields } from '../constants'

export default function EducationalDetailEditPage() {
  const { id } = useParams()
  ...
  const handleSubmit = (values) => {
    ...
    setError('')
    updateEducationalDetail(id, values)
  ...
  return (
    <div>
      <PageHeader title="Edit Educational Detail" subtitle="Update this educational detail record." />
