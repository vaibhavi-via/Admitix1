...
import { getApplicationPreferencesById, updateApplicationPreference } from '../services'
import { applicationPreferencesFields } from '../constants'

export default function ApplicationPreferenceEditPage() {
  const { id } = useParams()
  ...
  const handleSubmit = (values) => {
    ...
    setError('')
    updateApplicationPreference(id, values)
  ...
  return (
    <div>
      <PageHeader title="Edit Application Preference" subtitle="Update this application preference record." />
