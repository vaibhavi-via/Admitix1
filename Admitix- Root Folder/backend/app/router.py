...
api_router.include_router(admission_cycles_router)
api_router.include_router(ai_verification_router)
api_router.include_router(ai_document_router)
api_router.include_router(application_preferences_router)
api_router.include_router(applications_router)
api_router.include_router(application_status_history_router)
...
api_router.include_router(educational_details_router)
api_router.include_router(entrance_exam_scores_router)
